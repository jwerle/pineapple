...
module.exports.define = function(Controller){
  ...
  if (!name) throw new Error("A controller needs a name for pineapple.controller.define()");

  AppController = typeof pineapple.controllers.Application === 'function' ? pineapple.controllers.Application : function(){};
  
  if (name !== 'Application') Controller.prototype = pineapple.utils.object.merge(new AppController(), Controller.prototype);
