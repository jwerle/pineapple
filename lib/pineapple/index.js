...
pineapple.prototype.bindAppModule = function(options) {
  ...
  if (utils.appStat(appPath)) this[ns] = utils.object.merge(require(localPath), utils.object.merge(this[ns], utils.appRequire(appPath)));
  // if no app module was found, then just require the local module
  else this[ns] = require(localPath);
  return this;
}
