...
global.pineapple = module.exports = pineapple = loader.load(__dirname).pineapple
...
// Attach default daemon lib
pineapple.daemon   = require('../daemon');

// Attach app daemon lib
if (utils.appStat('/lib/daemon')) {
  pineapple.daemon = utils.object.merge(pineapple.daemon, utils.appRequire('/lib/daemon'));
}
...
if (pineapple.utils.stat(pfile = APP_PATH  + '/.pineapple')) {
  console.log("Found the .pineapple file. => ".cyan + pfile);
  require(pfile);
}
