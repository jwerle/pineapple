...
pineapple.__defineGetter__('exit', function(){
  process.exit();
});
...
pineapple.models.get = function(name, prevent_creation) {
  ...
  Model = new pineapple.utils.valueFromPath(name, pineapple.models)

  pineapple.utils.inherit(pineapple.model.Model, Model);

  model = new Model(pineapple.model.Model);
