...
http.JSONResponse = function JSONResponse(httpCode, vars, data) {
  var self = this, cons

  code = pineapple.objects.http.codes[httpCode] || httpCode
  ...
  this.code    = (typeof code === 'number')? code : code.code; 
  ...
  if (code.error)
    this.error  = pineapple.utils.parseStringVariables(code.error, vars || {});
