    ...
    !function(server, route, method) {
      method.call(server, route.route, function(request, response, next){
        ...
        if ((controller = pineapple.controller.get(controller)) && controller.isController) {
          ...
          c = pineapple.utils.object.merge(new pineapple.Base(), c);
          c = pineapple.utils.object.merge(new pineapple.controller.Controller(), c);

          if (typeof pineapple.controllers.Application === 'function')
            c = pineapple.utils.object.merge(new pineapple.controllers.Application(), c);
