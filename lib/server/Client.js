...
['get', 'post', 'put', 'del', 'head', 'options'].map(function(method){
  server.Client.prototype[method] = function() {
...
server.Client.prototype.generateUserAgent = function() {
  ...
  return [appName + '/' + appVersion, '(Pineapple-Client/' + pineapple.VERSION +')'].join(' ');
}
