...
module.exports.parseStringVariables = function(string, vars) {
  ...
  for (key in vars) {
    ...
    string = string.replace(regex, vars[key]); // Set the vars
  }
...
module.exports.appRequire = function(path, logging) {
  ...
  logging = IS_EXECUTED_FROM_BIN? logging : false
  var msg = "Requiring ".cyan + path
...
module.exports.appStat = function(path) {
  if (APP_PATH !== PINEAPPLE_PATH && IS_EXECUTED_FROM_BIN) {
...
module.exports.object.clone = function(object) {
  return (function(){ 
